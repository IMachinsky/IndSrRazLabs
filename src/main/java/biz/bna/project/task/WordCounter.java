...
public class WordCounter implements Runnable{
    ...
    private void insertFileInDb(String filePath, Map<String, Integer> wordsRepeat) throws SQLException {
        ...
        wordsRepeat.keySet().stream().parallel().forEach(wordText -> {
            ...
            try {
                words = wordRepository.findWhere(wordWhere, wordText);
            ...
            repeats = repeatRepository.findWhere(repeatWhere, params);
            if (repeats.isEmpty()) {
